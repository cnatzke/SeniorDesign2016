...
//October 30 2016
//
//This macro works the same as AngularCorrAlt.C, but works in GRSISort instead. It should have greater resolution because the fitting method.
//
...
angularCorr::angularCorr(){
	...
	vector<Double_t> rawcounts=FitHisto(histVec, angSplits, ELow, EHigh, secPeak);
...
//**********************************************************************************
vector<TH1D*> angularCorr::AngCut(TH3D* xyzProj, Int_t angSplits,Double_t gateLow, Double_t gateHigh){
...
//**********************************************************************************
vector<Double_t> angularCorr::FitHisto(vector<TH1D*> histVec,Int_t angSplits, Double_t ELow,Double_t EHigh, Double_t secPeak){
	...
	vector<TF1*> fitVec(angSplits); 
	vector<Double_t> counts(angSplits); 
...
//**********************************************************************************
vector<Double_t> angularCorr::WeightAdjust(vector<Double_t> counts, Int_t angSplits){
...
//**********************************************************************************
vector<Double_t> angularCorr::AltError(vector<Double_t> counts, Int_t angSplits){
...
//Normalizes Errors
//**********************************************************************************
vector<Double_t> angularCorr::ErrorAdjust(vector<Double_t> errorfit, Int_t angSplits){
...
//**********************************************************************************
void angularCorr::AngularCorrHisto(vector<Double_t> wcounts, TString isotope,vector<Double_t> countErrors,Int_t gndstate){
...
void angularCorr::CountFold(vector<Double_t> counts,vector<Double_t> errors,Int_t gndstate){
