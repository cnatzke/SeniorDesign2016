...
AngularCorrBeam::AngularCorrBeam(){
...
//**********************************************************************************
vector<TH1D*> AngularCorrBeam::AngCut(TH3D* xyzProj, Int_t angSplits,Double_t gateLow, Double_t gateHigh){
...
//**********************************************************************************
vector<Double_t> AngularCorrBeam::FitHisto(vector<TH1D*> histVec,Int_t angSplits, Double_t ELow,Double_t EHigh){
...
//**********************************************************************************
vector<Double_t> AngularCorrBeam::ErrorFits(vector<TH1D*> histVec,Int_t angSplits, Double_t ELow,Double_t EHigh){
...
//**********************************************************************************
vector<Double_t> AngularCorrBeam::WeightAdjust(vector<Double_t> counts, Int_t angSplits){
...
//**********************************************************************************
vector<Double_t> AngularCorrBeam::AltError(vector<Double_t> counts, Int_t angSplits){
...
//Normalizes Errors
//**********************************************************************************
vector<Double_t> AngularCorrBeam::ErrorAdjust(vector<Double_t> errorfit, Int_t angSplits){
...
//**********************************************************************************
void AngularCorrBeam::AngularCorrHisto(vector<Double_t> wcounts, TString isotope,vector<Double_t> countErrors,Int_t gndstate){
...
void AngularCorrBeam::CountFold(vector<Double_t> counts,vector<Double_t> errors,Int_t gndstate){
